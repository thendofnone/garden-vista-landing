...
import heroImg1 from '@/assets/formeverdi-01.webp';
import heroImg2 from '@/assets/formeverdi-02.webp';
import heroImg3 from '@/assets/formeverdi-03.webp';
  ...
  return (
    <section className="relative h-screen w-full overflow-hidden">
      ...
      <div
        ...
        <a
          href="#contact"
          className="bg-garden-dark-green text-white px-10 py-5 text-xl rounded-md hover:bg-garden-light-green transition-colors duration-300 font-medium tracking-wide hero-text-rise drop-shadow-[0_4px_16px_rgba(0,0,0,0.3)]"
